  ...
  <div id="container">
	...
	<form action='' method='post'>
		...
		<label for="licenceTitle">Titre
		    <input type='text' name='licenceTitle' value='<?php if(isset($error)){ echo html($_POST['licenceTitle']); } ?>'>
		</label>
		</div>

		<br><p class="right">
		<input type='submit' name='submit' class="button small orange" value='Ajouter la licence'>
		&nbsp;
